      ...
      <>
          ...
          <div className="flex flex-col w-full gap-3">
            {blockedAddresses.map((address, index) => (
              ...
              >
                ...
                <button className="cursor-pointer transition-class bg-[#2789bed1] px-3 py-2 rounded-lg hover:opacity-80 transition-class flex items-center justify-center w-32">
                  Unblock
                </button>
              </div>
            ))}
        ...
        <div className="w-full gap-3 text-white border border-gray-700 bg-[#161a2342] rounded-lg px-4 py-2 flex justify-between ">
          <input
            ...
            className="flex w-[60%]"
          />
          <button className="cursor-pointer self-end transition-class bg-[#ff2d2db5] px-3 py-2 mr-1 rounded-lg hover:opacity-80 transition-class flex items-center justify-center w-32">
            Block
          </button>
        </div>
      </>
