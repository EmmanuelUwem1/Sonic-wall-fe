...
export default function GetStarted() {
    return (
      <div className="flex border border-gray-700 rounded-lg p-4 cursor-pointer hover:bg-[#2789be0f] bg-[#161a2342] glass w-full h-full justify-center items-center flex-col gap-4 transition-class max-lg:mb-8">
